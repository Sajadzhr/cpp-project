...
void matrixDeterminantOp() {
    ...
    cout << "Note: Determinant is calculated for square matrices (up to " << MAX_SIZE << "x" << MAX_SIZE << ")" << endl;
    cout << "      Using recursive method (Laplace Expansion)" << endl;

    cout << "\nEnter size of square matrix (1-" << MAX_SIZE << "): ";
    cin >> size;
